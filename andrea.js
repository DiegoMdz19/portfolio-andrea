...
function loadContactoForm(){
  if(contactoCargado) return; // 🚫 evita múltiples ejecuciones
  contactoCargado = true;

  // 🔥 limpia posibles duplicados en pantalla
  const contenedor = document.querySelector('.contacto-info');
